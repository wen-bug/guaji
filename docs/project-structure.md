...
当前主要玩法是家园点击交互、招募队友、队伍排序、种田、炼器、炼丹、自动历练战斗、背包、装备、属性成长、五行与突破。玩家点击家园节点后打开对应 HUD 面板；点击打怪入口会通过加载遮罩进入历练地图，随机遇怪并由全队自动战斗。
...
- 成长：玩家与队友经验升级、自动属性成长、伙伴成长主属性、突破道具、根骨突破。
...
- 招募 HUD：显示候选人、材料成本、队伍顺序、上移/下移和队友离队。
